...
export async function processarPagamentoAprovado({
    ...
    try {
        ...
        // 2. IDEMPOTÊNCIA
        // =========================================================
        // O pagamento pode já estar como "approved" no pedido
        // porque o pagamento com cartão é aprovado imediatamente
        // e o endpoint /card salva esse status antes do webhook.
        //
        // Portanto, "status_pagamento = approved" NÃO significa
        // que o processamento do pagamento já foi concluído.
        //
        // O processamento definitivo é identificado por:
        // - paid_at preenchido
        // - mesmo mp_payment_id do pagamento recebido
